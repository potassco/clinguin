...
class IPythonFrontend(AbstractFrontend):
    ...
    def window(self, cid, parent, attributes, callbacks):
        print("IPython - WINDOW: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::" + str(callbacks))

    def container(self, cid, parent, attributes, callbacks):
        print("IPython - CONTAINER: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::" + str(callbacks))

    def dropdown_menu(self, cid, parent, attributes, callbacks):
        print("IPython - DROPDOWNMENU: " + str(cid) + "::" + str(parent) + "::" + str(attributes)
              + "::" + str(callbacks))

    def dropdown_menu_item(self, cid, parent, attributes, callbacks):
        print("IPython - DROPDOWNMENUITEM: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))

    def label(self, cid, parent, attributes, callbacks):
        print("IPython - LABEL: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))

    def button(self, cid, parent, attributes, callbacks):
        print("IPython - BUTTON: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))

    def menu_bar(self, cid, parent, attributes, callbacks):
        print("IPython - MENUBAR: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))

    def menu_bar_section(self, cid, parent, attributes, callbacks):
        print("IPython - MENUBARSECTION: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))

    def menu_bar_section_item(self, cid, parent, attributes, callbacks):
        print("IPython - MENUBARSECTIONITEM: " + str(cid) + "::" + str(parent) + "::" + str(attributes) + "::"
              + str(callbacks))
