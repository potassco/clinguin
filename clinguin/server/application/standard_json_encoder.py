...
class StandardJsonEncoder:
    """
    The standrd json encoder is responsible for converting a UIFB into a json hierarchy.
    """
    ...
    def _generate_hierarchy(cls, uifb, hierarchy_root, elements_dict):
        ...
        for element_id in order:
            ...
            if element_id in cbs:
                elem_callbacks = [
                    CallbackDto(a.id, a.action_type, a.interaction_type, a.policy) for a in cbs[element_id]
                ]
