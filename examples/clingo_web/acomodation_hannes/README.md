...
```shell
clinguin client-server --frontend AngularFrontend --domain-files examples/clingo_web/acomodation_hannes/instance.lp examples/clingo_web/acomodation_hannes/encoding.lp --ui-files examples/clingo_web/acomodation_hannes/ui.lp
```
